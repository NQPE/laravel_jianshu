        ...
        <form action="/posts/search" method="GET">
            ...
            <ul class="nav navbar-nav navbar-right">
                @if(\Illuminate\Support\Facades\Auth::check())
                    <li class="dropdown">
                        <div>
                            <img src="{{\Illuminate\Support\Facades\Auth::user()->avatar}}" alt="" class="img-rounded"
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="/user/index/{{\Illuminate\Support\Facades\Auth::id()}}">我的主页</a></li>
                ...
                @else
                    <li>
                        <a class="blog-nav-item " href="/login">请登录</a>
                    </li>
                @endif
            </ul>
        </form>
